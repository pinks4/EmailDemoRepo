...
//reusable methods not related to application but generic reusable methods like opening browser, closing browser,maximizing a page,etc
	...
	public void openBrowser(String browserType){
		...
		eTest.log(LogStatus.INFO, "Browser"+browserType+"is opened");
    ...
    public void reportFail(String message){
    	...
    	Assert.fail(message); //to fail the testNG test
